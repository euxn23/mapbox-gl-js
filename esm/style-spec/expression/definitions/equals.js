...
function makeComparison(op, negate) {
  return class Comparison {
    ...
    evaluate(ctx) {
      const equal = this.collator ? this.collator.evaluate(ctx).compare(this.lhs.evaluate(ctx), this.rhs.evaluate(ctx)) === 0 : this.lhs.evaluate(ctx) === this.rhs.evaluate(ctx);
