...
class Literal {
  ...
  static parse(args, context) {
    ...
    const value = args[1];
    let type = typeOf(value); // special case: infer the item type if possible for zero-length arrays
  ...
  serialize() {
    if (this.type.kind === 'array' || this.type.kind === 'object') {
      ...
      assert(this.value === null || typeof this.value === 'string' || typeof this.value === 'number' || typeof this.value === 'boolean');
      return this.value;
    }
  }
