...
class DragRotateHandler {
  ...
  constructor(map, options) {
    ...
    bindAll(['_onMouseMove', '_onMouseUp', '_onBlur', '_onDragFrame'], this);
  }
  /**
  ...
  onMouseDown(e) {
    ...
    DOM.disableDrag(); // Bind window-level event listeners for move and up/end events. In the absence of
    ...
    window.document.addEventListener('mouseup', this._onMouseUp); // Deactivate when the window loses focus. Otherwise if a mouseup occurs when the window
