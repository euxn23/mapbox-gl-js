...
class CircleStyleLayer extends StyleLayer {
  ...
  queryIntersectsFeature(queryGeometry, feature, geometry, zoom, transform, pixelsToTileUnits, posMatrix) {
    ...
    const size = radius + stroke; // For pitch-alignment: map, compare feature geometry to query geometry in the plane of the tile
...
function projectPoint(p, posMatrix, transform) {
  ...
  return new Point((point[0] / point[3] + 1) * transform.width * 0.5, (point[1] / point[3] + 1) * transform.height * 0.5);
}
