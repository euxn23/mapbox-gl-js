...
class CanvasSource extends ImageSource {
  ...
  constructor(id, options, dispatcher, eventedParent) {
    super(id, options, dispatcher, eventedParent); // We build in some validation here, since canvas sources aren't included in the style spec:
  ...
  load() {
    if (!this.canvas) {
      this.canvas = this.options.canvas instanceof window.HTMLCanvasElement ? this.options.canvas : window.document.getElementById(this.options.canvas);
    }
