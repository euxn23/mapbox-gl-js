...
import RasterTileSource from './raster_tile_source'; // ensure DEMData is registered for worker transfer on main thread:
...
class RasterDEMTileSource extends RasterTileSource {
  ...
  _getNeighboringTiles(tileID) {
    ...
    const neighboringTiles = {}; // add adjacent tiles
